...
companyAdminRouters.put("/", authVerify([userRoles.companyAdmin]), upload.fields([{ name: "image", maxCount: 1 }, { name: "logo", maxCount: 1 }]), companyAdminController.updateCompanyAdminProfile);
