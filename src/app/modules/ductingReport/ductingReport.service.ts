...
const addOrReplaceDuctingReport = async (userId: ObjectId, payload: TDuctingReport, files?: { client_approved_signature?: TFile[]; signed_on_completion_signature?: TFile[] }) => {
